...
@section('panel')
<style>
    span.sos.badge.badge--warning {
    display: block;
    overflow: auto !important;
    width: 166% !important;
}

span.sos.badge.badge--warning::-webkit-scrollbar { 
                            ...
                            <x-admin.ui.table.body>
                                @forelse($soss as $sos)
                                    <tr>
                                        <td>
                                            @if ($sos->user_id)
                                                <div
                                                    ...
                                                    <div>
                                                        <span
                                                            class="d-block fs-14">{{ @__($sos->ride->driver->fullname) }}</span>
                                                    ...
                                                    <div>
                                                        <span
                                                            class="d-block fs-14">{{ __(@$sos->ride->user->fullname) }}</span>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.rides.detail', $sos->ride_id) }}">
                                                {{ $sos->ride?->uid }}
                                            </a>
                                        </td>
                                        <td>
                                            <span class="sos badge badge--warning">{{ $sos->message }}</span>
                                        </td>
                                        <td>
                                            <div>
                                                <span class=" d-block">
                                                ...
                                                <span class="fs-12 text--info">
                                                    {{ diffForHumans($sos->created_at) }}
                                                </span>
                                            </div>
                                        </td>
                                        <!-- <td>
                                            <x-admin.ui.btn.details text="Show Review" tag="btn" :data-review="$sos" />
                                        </td> -->
                                    </tr>
                                @empty
