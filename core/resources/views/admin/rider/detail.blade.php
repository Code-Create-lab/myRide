                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            @foreach($user->userReviews as $userReview)

                           
                            <li class="list-group-item d-flex justify-content-between ps-0 flex-wrap">
                                <span>@lang('Review') / @lang('Rating')</span>
                                <span> Ride-Id  <a href="{{ route('admin.rides.detail',$userReview->ride->id ) }}" style="font-weight: bold">  {{ $userReview->ride->uid }} </a> </span>
                                <span> {{ __($userReview->review) }} </span>
                                <span> {{ $userReview->rating }} </span>
                             <a href="{{  route('admin.reviews.delete', $userReview->id )}}">  <button class="btn-danger btn text-white" style="color: white !important">Delete</button></a> 
                            </li>
                            {{-- <li class="list-group-item d-flex justify-content-between ps-0 flex-wrap">
