            ...
            <x-admin.ui.card>
                ...
                <x-admin.ui.card.body>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between ps-0 flex-wrap">
                            <span>@lang('Booking Date')</span>
                            <span>
                                {{-- @lang('Approximately') --}}
                                <span class="text--info"> {{ __(@$ride->pickup_date_time) }}</span>
                            </span>
                        </li>
                        @endif
                    </ul>
            ...
            <x-admin.ui.card>
                ...
                <x-admin.ui.card.body>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between ps-0 flex-wrap">
                            <span>@lang('Cancel Reason')</span>
                            <span> @php echo $ride->cancel_reason @endphp </span>
                        </li>
                    </ul>
                </x-admin.ui.card.body>
            </x-admin.ui.card>
        </div>
        <div class="col-lg-{{ (!$ride->is_scheduled  ? '6': '12' )}}">
            <x-admin.ui.card>
                <x-admin.ui.card.header>
                ...
                <x-admin.ui.card.body>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between ps-0 flex-wrap">
                            ...
                            <span> {{ __(@$ride->user->avg_rating) }} </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between ps-0 flex-wrap">
            ...
            <x-admin.ui.card>
                ...
                <x-admin.ui.card.body>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between ps-0 flex-wrap">
                            <span>@lang('Vechicle No')</span>
                            <span> {{  $ride->driver->vehicle_data[1]->value ?? 'No driver available' }} </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between ps-0 flex-wrap">
                            <span>@lang('Total Canceled Ride')</span>
