            ...
            <x-admin.ui.card>
                ...
                <x-admin.ui.card.body>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center ps-0">
                            <span class="text-muted"> <i class="las la-envelope"></i> @lang('Contact No (Helpline)')</span>
                            <span>{{ $admin->contact_no }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center ps-0">
    ...
    <x-admin.ui.modal id="profileModal">
        ...
        <x-admin.ui.modal.body>
            <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>@lang('Contact (Helpline)')</label>
                    <input class="form-control" type="text" name="contact_no" value="{{ $admin->contact_no }}" required>
                </div>
                <div class="form-group">
