    ...
    <x-admin.ui.card class="tc-card">
        <x-admin.ui.card.header class="flex-between gap-2 py-3">
            ...
            <div class="d-flex gap-2 flex-wrap flex-md-nowrap">
                <select class="form-select form-control form-select-sm trans_chart">
                ...
                <div class="date-picker-wrapper-trans d-none w-100">
                    <input type="text" class="form-control form-control-sm date-picker date-picker-trans" name="date"
    ...
    <script>
        ...
        (function($) {
            ...
            const transactionChart = (startDate, endDate) => {
                ...
                const timePeriod = $(".trans_chart").val();
                if (timePeriod == 'date_range') {
                    $(".date-picker-wrapper-trans").removeClass('d-none')
                } else {
                    $(".date-picker-wrapper-trans").addClass('d-none')
                }
                const date = $(".date-picker-trans").val();
                const data = {
