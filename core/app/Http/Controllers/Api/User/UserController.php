...
class UserController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $user        = auth()->user();
        $rules = RiderRule::get();
        // $runningRide = Ride::rideRunning()->where('user_id', $user->id)->with(['user', 'driver'])->first();
        $runningRide = Ride::where('user_id', $user->id)->with(['user', 'driver'])->orderBy('id', 'desc')->first();
        // dd($runningRide);
    ...
    public function addDeviceToken(Request $request)
    {
        ...
        $deviceToken = DeviceToken::where('token', $request->token)->where('user_id',auth()->user()->id)->first();
