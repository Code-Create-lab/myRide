...
class RideController extends Controller
{
    ...
    {
        $ride = Ride::with(['bids', 'user', 'driver', 'service', 'userReview', 'driverReview', 'driver.brand', 'service'])->find($id);
    ...
    // $finalPrice = $totalPrice + $gstPrice ;
        ...
        //     'ride_amount' => number_format((float)$ride->amount , 2, '.', ''),
    ...
    public function list()
    {
        ...
        // dd("adsas");
        $ride   = Ride::where('driver_id',14)
        ->first();

        // dd($ride->user->firstname ,    $ride->user->lastname);
